...
import publiccodeRulesets from './specs/publiccode-05/rulesets';
...
const rulesetGroups = collectRulesetGroups(
  ...
  { slug: 'adr-consult', rulesets: adrConsultRulesets },
  {
    ...
    targets: [
      { slug: 'publiccode-05', filter: uri => uri === 'https://yml.publiccode.tools/schema/0.5' },
      { slug: 'publiccode-07', filter: uri => uri === 'https://yml.publiccode.tools/schema/0.7' },
    ],
  },
);
